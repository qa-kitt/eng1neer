...
- **eng1neer@rand0m.ai** + :taco::taco::taco:
...
- <span style="color:#F4AFDA"><u>Automation:</u></span> Cypress, Selenium, WebDriverIO, Postman, Powershell, ServiceNow, MongoDB, Robo3T, Fiddler, OctoPerf
- <span style="color:#F4AFDA"><u>Other:</u></span> Docker, Node/React.js, Jira

:taco: **EXPOSURE (< 3 yrs):**

- <span style="color:#F4AFDA"><u>Google:</u></span> Firebase, Flutter/Dart, Cloud,
- <span style="color:#F4AFDA"><u>Microsoft:</u></span> Visio, PowerBI, AKS
- <span style="color:#F4AFDA"><u>Automation:</u></span> ReadyAPI, JMeter, LoadRunner, BrowserStack, Appium, SauceLabs
- <span style="color:#F4AFDA"><u>Other:</u></span> Terraform, Kentico, Figma, Zepplin, ARCore
